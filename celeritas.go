...
import (
    ...
    "github.com/folkersj/celeritas/cache"
    "github.com/folkersj/celeritas/mailer"
    "github.com/folkersj/celeritas/render"
    "github.com/folkersj/celeritas/session"
...
func (c *Celeritas) New(rootPath string) error {
    ...
    if os.Getenv("CACHE") == "redis" || os.Getenv("SESSION_TYPE") == "redis" {
        ...
        myRedisCache.Prefix = os.Getenv("REDIS_PREFIX")
    ...
    if c.Debug {
        var views = jet.NewSet(jet.NewOSFileSystemLoader(
            fmt.Sprintf("%s/views", rootPath)),
